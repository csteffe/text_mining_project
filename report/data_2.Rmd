...
# Divide the book into texts for each chapter
```{r}
...
```{r}
# Lemmatization
invisible.tk <- invisible.tk %>%  tokens_replace(pattern=hash_lemmas$token, replacement = hash_lemmas$lemma)
