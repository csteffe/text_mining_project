...
Lemmatization simplifies tokens by generating tokens from a dictionary and reduces the vocabulary to its simplest and meaningful essence. Consequently, the set of token types in a corpus is sreduced. For example, "started" and "starts" are reduced to "start" and have thus "start" as a lemma. 
