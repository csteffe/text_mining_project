...
For interpretation matter, since it is important here, we decide not to use the stemming in the rest of our analysis. But we do it for demonstration purpose.
...
Now, without considering the stemming, we compute the **Document-Term-Matrix** that will be useful all along our work.
...
For example, the $log(f_women) \approx a + b*log(r_women) \approx ?$ "pas necessaire a mon avis"
