...
mattr <- data.tk2 %>% 
         textstat_lexdiv(measure = "MATTR", 
                         MATTR_window = 80)    # determines the size of the window to use [je pense que 80 c'est bien parce que ça améliore le MATTR et plus ça change pas grand chose + chapter 15 est le plus riche]
