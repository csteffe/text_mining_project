...
chapter 14,*Women's Rights are Human Rights*,has a large frequency of the term *datum*.
...
The following plot shows the 10 highest TF-IDF associated with their chapter. For example the term *tax* is still really frequent and now specific to chapter 13 whereas chapter 10 is now associated with *trial* and *drug*. Chapter 14 is in fact more specifically associated with the term *interrupt* than with the term *female* in TF by document.
