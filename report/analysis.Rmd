...
Distances (i.e. similarities) between documents in the RWMD approach calculate how hard it is to transform words from one document into words from another document and vice versa. 
