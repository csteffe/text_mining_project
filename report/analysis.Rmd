...
much more no similarity (darker blue squares) between terms used in different chapters than the previous one. However, chapter 10 and 11 still are shown as being the ones with the greatest similarity. 
...
From the clustering, we extract the ten words that are the most used. It is interesting to observe that cluster one seems more to have words about transport and work, cluster two about car, and cluster 3 about medical. 
