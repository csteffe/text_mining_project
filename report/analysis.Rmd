...
The SVM method is a machine learning method, that is very different compared random forest. SVM tries to classified classes by separating data points, by a vector that we want to be as large as possible, in our class the SVM is used to predict multiple classes and not only two.   
