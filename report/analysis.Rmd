...
First, to obtain a set of structured features, we generate a DTM of dimensions 245 by 5,738 with term frequencies. Since the DTM is relatively large, we reduce its dimension using the Latent Sementic Analysis (LSA) by targetting 30 dimensions. Note that we already remove the stop words in the cleaning and that we previously make sure that they are unimportant to our analysis.
