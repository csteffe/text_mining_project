...
The prevalence is the the topic distribution (proportion) in a corpus and it is given by the sum of all the $\theta$ for a topic, divided by the sum of all $\theta$. Note that th formula does not consider the chapter's length.
