...
# Build the model
data.rwmd.model <- RelaxedWordMoversDistance$new(data.dfm, data.we)
data.rwms <- data.rwmd.model$sim2(data.dfm)
data.rwmd <- data.rwmd.model$dist2(data.dfm)
## speech.rwmd ## check out
...
plot(data.derwms, 
     ...
     xlab = "Dim 1", 
     ylab = "Dim 2", 
     main = "Document embedding - RWMD+CMD")
