...
The overall statistics demonstrates an overall accuracy (i.e. proportion of correct predictions) of 81.2% and balanced accuracy (i.e. average between sensitivity and specificity) for the classes over 76.8% as well, indicating that our model is good. The interesting fact here is that even after reducing the dimension to 30 of the DTM, we still obtain a high accuracy. 
