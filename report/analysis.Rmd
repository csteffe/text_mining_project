...
For a coherent topic, the terms associated to this topic (large theta) are used in the same documents.
Indeed, suppose that the documents where the top term W appears never contain all the other top terms. Then, this top term W is not belonging to the topic. The topic is not coherent.
