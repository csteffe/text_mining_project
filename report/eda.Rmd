...
The following visualization plots the 10 most frequent terms in the whole corpus. The plot indicates that the term *women* is the most frequent term overall, appearing almost 1,250 times in the corpus, which also means that it is the least document specific term. In addition we can see that the term "data" has been changed by lemmatization to "datum". 
...
dfm.nowoman <- data.tk2%>% tokens_remove(c("women","female","woman"))%>%dfm()

nowoman.10 <- dfm.nowoman %>% 
