...
The following visualization plots the 10 most frequent terms in the whole corpus. The plot indicates that the term *woman* is the most frequent term overall, appearing 1594 times in the corpus, which also means that it is the least document specific term. Moreover *woman* appears four times more than the second most frequent term *female* in the corpus and this huge difference could hide some insights. 
In addition we can see that the term "data" has been changed by lemmatization to "datum". 
...
This Cloud of Words shows the most frequent terms for the corpus.
...
```
Unsurprisingly, the term "woman" is at the center of the cloud of words due to its high frequency throughout the corpus. However, its high frequency may mask important information as this term does not provide any value. Thus, "woman" will be removed for the rest of our analysis.
...
dfm.nowoman <- data.tk2 %>% tokens_remove(c("female","woman"))%>% dfm()
